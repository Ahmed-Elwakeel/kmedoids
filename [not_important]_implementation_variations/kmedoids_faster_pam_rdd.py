...
if __name__ == "__main__":
    ...
    # [0.1,0.2,....]  | string_id
    # [0.4,....... ]  | string_Id
    embeddings_df_string_id = formulate_embeddings("embeddings/input/1000000_sampled_embeddings.csv")
    ...
    # final_res_rdd = new_joined_rdd.map(lambda x: func4(x) )
    
    # final_res_rdd = final_res_rdd.toDF()
    # final_res_rdd.show(200,False)
    
    # other_join_df = other_join_rdd.toDF()
    # other_join_df.show(200,False)
    # filtered_joined_df = filtered_joined_rdd.toDF()
    # filtered_joined_df.show(200,False)

    # new_joined_df = new_joined_rdd.toDF()
    # new_joined_df.show(200, False)
  
    
    # pair_wise_distance_rdd = pair_wise_distance_df.rdd
